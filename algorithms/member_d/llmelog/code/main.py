...
from src.utils import get_abs_path, ensure_local_bert_model
...
def parse_args():
    ...
    parser.add_argument('--dataset', default='hdfs', type=str,
                        help='dataset name')
    parser.add_argument('--auto_download_bert', nargs='?', const=True, default=True, type=str2bool,
                        help='download google-bert/bert-base-uncased into bert-base-en if local weights are missing')
    parser.add_argument('--bert_model_id', default='google-bert/bert-base-uncased', type=str,
                        help='Hugging Face model id for the base BERT encoder')
...
def main():
    args = parse_args()
    if args.auto_download_bert and args.encoder != 'None':
        ensure_local_bert_model(model_id=args.bert_model_id)
